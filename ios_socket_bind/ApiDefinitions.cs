...
namespace ios_Socket_Bind
{
    ...
    [BaseType(typeof(NSObject), Name = "_TtC6iOSTCP17HelloWorldWrapper")]
    interface HelloWorldWrapper
    {
        // -(NSInteger)MyFunction1 __attribute__((warn_unused_result("")));
        [Export("MyFunction1")]
        nint MyFunction1 { get; }

        // -(NSInteger)MyFunction2 __attribute__((warn_unused_result("")));
        [Export("MyFunction2")]
        nint MyFunction2 { get; }

        // -(NSInteger)MyFunction3 __attribute__((warn_unused_result("")));
        [Export("MyFunction3")]
        nint MyFunction3 { get; }
    }
